...
public class LaptopsAndNotebooksTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        softAssert.assertEquals(productPage.getProductText(), "MacBook", "MacBook Product not display");
        productPage.clickOnAddToCartButton();
        softAssert.assertEquals(productPage.getProductAddedSuccessMessage().contains("Success: You have added MacBook to your shopping cart!"),
                "Product not added to cart");
        productPage.clickOnShoppingCartLinkIntoMessage();
        softAssert.assertEquals(cartPage.getShoppingCartText(),"Shopping Cart");
        softAssert.assertEquals(cartPage.getProductName(), "MacBook", "Product name not matched");
        cartPage.changeQuantity("2");
        cartPage.clickOnQtyUpdateButton();
        softAssert.assertEquals(cartPage.getSuccessModifiedMessage(),"Success: You have modified your shopping cart!");
