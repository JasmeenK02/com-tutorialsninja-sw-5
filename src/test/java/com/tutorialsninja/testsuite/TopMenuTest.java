...
public class TopMenuTest extends BaseTest {
    ...
    public void verifyUserShouldNavigateToDesktopsPageSuccessfully() throws InterruptedException {
        ...
        softAssert.assertEquals(actualText, expectedText, "Not navigate to Desktop page");
    }
    ...
    public void verifyUserShouldNavigateToLaptopsAndNotebooksPageSuccessfully() throws InterruptedException {
        ...
        softAssert.assertEquals(laptopsAndNotebooksPage.getLaptopsAndNotebooksText(),
    ...
    public void verifyUserShouldNavigateToComponentsPageSuccessfully() throws InterruptedException {
        ...
        softAssert.assertEquals(componentsPage.getComponentsText(),
