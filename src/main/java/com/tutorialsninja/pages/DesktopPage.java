...
//    WebElement productsList;
    ...
    public String getDesktopsText() {
        ...
        CustomListeners.test.log(Status.PASS, " Desktops Text " );
        Reporter.log(" Desktops Text  " + desktopsText.toString());
        return getTextFromElement(desktopsText);
    }

    public ArrayList<String> getProductsNameList() {

        CustomListeners.test.log(Status.PASS, " Products Name List ");
        Reporter.log(" Products Name List ");
